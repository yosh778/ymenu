...
public:
  ...
  int PixelSize(int textureMode);
	...
	///
	//////////////////////////////////////////////////////////////////////////
	JTexture* LoadTexture(const char* filename, int mode = 0, int textureFormat = TEXTURE_FORMAT, void* binData = NULL, unsigned int binSize = 0, bool dxppng = false);
...
private:
	...
	int LoadPNG(TextureInfo &textureInfo, const char *filename, int mode = 0, int TextureFormat = TEXTURE_FORMAT, void* binData = NULL);
	int LoadDXPNG(TextureInfo &textureInfo, const char* filename, int mode = 0, void* binData = NULL, unsigned int binSize = 0);
